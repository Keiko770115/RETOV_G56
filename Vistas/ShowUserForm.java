...
public class ShowUserForm extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtSucursal.setBackground(new java.awt.Color(153, 153, 255));

        txtNombres.setBackground(new java.awt.Color(153, 153, 255));

        jLabel3.setText("Nombre(s)");

        txtApellidos.setBackground(new java.awt.Color(153, 153, 255));

        jLabel4.setText("Apellido(s)");

        txtTipoDoc.setEditable(false);
        txtTipoDoc.setBackground(new java.awt.Color(153, 153, 255));

        jLabel5.setText("Tipo documento");

        txtDocumento.setEditable(false);
        txtDocumento.setBackground(new java.awt.Color(153, 153, 255));
        ...
        txtSubordinador.setBackground(new java.awt.Color(153, 153, 255));

        jLabel11.setText("Tipo de transporte");

        cbTipoTransporte.setBackground(new java.awt.Color(153, 153, 255));
        ...
        rb_si.setBackground(new java.awt.Color(153, 153, 255));
        rb_si.setText("Sí");

        rb_no.setBackground(new java.awt.Color(153, 153, 255));
        rb_no.setText("No");

        jLabel9.setText("Ocupación");

        txtOcupacion.setEditable(false);
        txtOcupacion.setBackground(new java.awt.Color(153, 153, 255));
